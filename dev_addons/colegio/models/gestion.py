...
class gestion(models.Model):
    ...
    curso_materia_ids = fields.One2many('colegio.curso_materia', 'gestion_id', string="Gestiones")
    modalidad_gestion_id = fields.Many2one('colegio.modalidad_gestion', string="Modalidad de Gestión", ondelete='cascade', required=True)
    inscripcion_ids = fields.One2many('colegio.inscripcion', 'gestion_id', string="Gestiones")
