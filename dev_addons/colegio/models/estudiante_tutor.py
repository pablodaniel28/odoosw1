...
class estudiante_tutor(models.Model):
    _name = 'colegio.estudiante_tutor'
    _description = 'Modelo o tabla estudiante tutor'


    relacion=fields.Char() 
    estudiante = fields.Many2one("colegio.estudiante",ondelete="cascade",help="estudiante relacionado",required=True)
    tutor = fields.Many2one("colegio.tutor", ondelete="cascade", help="Tutor relacionado", required=True)
