...
class curso(models.Model):
    ...
    curso_materia_ids = fields.One2many('colegio.curso_materia', 'curso_id', string="Cursos")
    inscripcion_ids = fields.One2many('colegio.inscripcion', 'curso', string="Cursos")
    
    ciclo_id = fields.Many2one('colegio.ciclo', string="Ciclo", ondelete='cascade', required=True)
